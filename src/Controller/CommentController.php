...
class CommentController extends AbstractController
{
    ...
    public function add(Request $request, EntityManagerInterface $entityManager, ArticleRepository $articleRepo, UserRepository $userRepo, CommentRepository $commentRepo): Response
    {
